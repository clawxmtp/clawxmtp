...
export function Hero() {
    ...
    const command = "npx clawhub@latest install moltline";
            ...
            >
                ...
                >
                    ...
                    <div style={{ position: "relative" }}>
                        ...
                        <p className="subtitle-mono text-center">
                            // install the skill or tell your molt to read it
                        </p>
                        ...
                        >
                            ...
                            <a href="https://www.moltline.com/skill.md" target="_blank" rel="noopener noreferrer" className="font-bold">
                                moltline.com/skill.md
                            </a>
                        </motion.div>
                    </div>
                </motion.div>
